...
data class IssueCardResult(
    @field:Schema(description = "The newly issued card's ID (32-character hex, no hyphens).", example = "d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1")
    val cardId: String,
    ...
    val brand: String,
    @field:Schema(description = "The card's lifecycle status. Always `ACTIVE` right after issuance.", example = "ACTIVE")
    val status: String,
