 ...
 *
 * [AccountRepository](쓰기 모델)와 분리해, Query Service가 save/deleteAccount 같은 쓰기 메서드에
 * 접근하지 못하도록 컴파일 타임에 강제한다. 실제 구현체(AccountRepositoryImpl)는 두 인터페이스를
 * 모두 구현하지만, 각 Service는 자신에게 필요한 인터페이스 타입으로만 주입받는다.
 */
