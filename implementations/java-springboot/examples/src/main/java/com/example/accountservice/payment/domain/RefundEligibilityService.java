 ...
 * parameter, breaking the boundary) — this is exactly where a Domain Service belongs. This is the
 * only reason this class exists — it carries no fraud-risk judgment of any kind, ML-based or
 * otherwise.
 */
