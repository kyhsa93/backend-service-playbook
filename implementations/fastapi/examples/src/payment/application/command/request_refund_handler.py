...
class RequestRefundHandler:
    ...
    async def execute(self, cmd: RequestRefundCommand) -> Refund:
        ...
        # status and the refund amount) is delegated to RefundEligibilityService (a Domain
        # Service), coordinated by this Application layer, which has loaded both the Payment
        # and Refund Aggregates.
