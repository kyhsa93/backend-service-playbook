...
// belongs here, in a separate Domain Service. Coordinating these two Aggregates is the entire
// reason this class exists — it carries no fraud-risk judgment of any kind.
// (See the root docs/architecture/domain-service.md.)
