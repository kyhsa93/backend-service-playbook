...
// rule verifiable only by loading both Aggregates together is why RefundEligibilityService is a
// Domain Service. This spec verifies that judgment directly (instantiated as a plain object with
// no NestJS dependency and no fraud-risk judgment of any kind).
