...
func TestCheckEventPlacement(t *testing.T) {
	t.Run("good", func(t *testing.T) {
		result := checkEventPlacement("testdata/event-placement/good")
	...
	t.Run("bad-wrong-dir", func(t *testing.T) {
		result := checkEventPlacement("testdata/event-placement/bad-wrong-dir")
