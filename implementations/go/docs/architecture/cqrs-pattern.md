...
func (h *CreateAccountHandler) Handle(ctx context.Context, cmd CreateAccountCommand) (*account.Account, error) {
	...
	if err := h.repo.SaveAccount(ctx, a); err != nil {          // Aggregate 저장 + Outbox 적재, 한 트랜잭션
		return nil, err
	}
