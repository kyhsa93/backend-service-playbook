...
| 작업 / 키워드 | 읽을 문서 |
|---|---|
| Aggregate, Entity, Value Object, Domain Event | `docs/architecture/tactical-ddd.md` |
...
| Domain Event, Outbox 패턴, Integration Event | `docs/architecture/domain-events.md` |
